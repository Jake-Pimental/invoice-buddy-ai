...
const StatCard = ({
  ...
  return (
    <div 
      className={cn(
        "relative bg-white dark:bg-gray-800 rounded-xl p-6 shadow-subtle border border-gray-100 dark:border-gray-700 transition-all duration-300 ease-apple animate-slide-up hover-scale dark:shadow-none",
        className
      )}
    >
